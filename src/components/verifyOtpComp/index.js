                    ...
                    <div className="mt-4 flex flex-wrap justify-center gap-2 sm:justify-between">
                        {otp.map((digit, index) => (
                            <input
                                ...
                                className="text-black w-10 h-10 sm:w-12 sm:h-12 text-center text-lg font-semibold rounded-md border border-gray-300 bg-gray-50 focus:ring-thirdColor focus:border-thirdColor"
                            />
                        ))}
                    </div>
